...
local Library = {
    ...
    Scheme = {
        ...
        MainColor = Color3.fromRGB(21, 20, 25),
...
if RunService:IsStudio() then
    if UserInputService.TouchEnabled and not UserInputService.MouseEnabled then
        ...
        Library.OriginalMinSize = Vector2.new(580, 420)
    end
else
    pcall(function()
    ...
    Library.OriginalMinSize = Library.IsMobile and Vector2.new(480, 240) or Vector2.new(580, 420)
end
...
function Library:CreateWindow(WindowInfo)
    ...
    do
        ...
        -- Bottom Bar was removed visually
        ...
        Tabs = New("ScrollingFrame", {
            ...
            Size = UDim2.new(0, InitialLeftWidth, 1, -48),
            Parent = MainFrame,
        })
        New("UIListLayout", {
            Parent = Tabs,
        ...
        Container = New("Frame", {
            ...
            Size = UDim2.new(1, -InitialLeftWidth, 1, -48),
            Parent = MainFrame,
        })
        New("UIPadding", {
    ...
    function Window:SetSidebarWidth(Width)
        ...
        Tabs.Size = UDim2.new(0, Width, 1, -48)
        Container.Size = UDim2.new(1, -Width, 1, -48)
    ...
    function Window:AddTab(...)
        ...
        Icon = Library:GetCustomIcon(Icon) or Library:GetCustomIcon("circle") or Library:GetCustomIcon("list")
        do
